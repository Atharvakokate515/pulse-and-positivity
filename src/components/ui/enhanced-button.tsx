  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        motivational: "bg-gradient-primary text-primary-foreground hover:scale-105 shadow-lg hover:shadow-xl",
        success: "bg-gradient-success text-success-foreground hover:scale-105 shadow-lg",
        soft: "bg-secondary/50 text-secondary-foreground hover:bg-secondary/70 border border-border/50"
      },
      size: {
